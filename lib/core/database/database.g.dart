...
class TodoTableData extends DataClass implements Insertable<TodoTableData> {
  final int id;
  final String title;
  const TodoTableData({required this.id, required this.title});
  @override
  ...
  TodoTableCompanion toCompanion(bool nullToAbsent) {
    return TodoTableCompanion(id: Value(id), title: Value(title));
  }
  ...
  TodoTableData copyWith({int? id, String? title}) =>
      TodoTableData(id: id ?? this.id, title: title ?? this.title);
...
class TodoTableCompanion extends UpdateCompanion<TodoTableData> {
  ...
  TodoTableCompanion copyWith({Value<int>? id, Value<String>? title}) {
    return TodoTableCompanion(id: id ?? this.id, title: title ?? this.title);
  }
...
typedef $$TodoTableTableCreateCompanionBuilder =
    TodoTableCompanion Function({Value<int> id, required String title});
typedef $$TodoTableTableUpdateCompanionBuilder =
    TodoTableCompanion Function({Value<int> id, Value<String> title});
    ...
    : super(
        TableManagerState(
          ...
          updateCompanionCallback:
              ...
              }) => TodoTableCompanion(id: id, title: title),
          createCompanionCallback:
              ({Value<int> id = const Value.absent(), required String title}) =>
                  TodoTableCompanion.insert(id: id, title: title),
